...
<div class="content-header">
    <div class="header-info">
        ...
        <div class="stats-info">
            <span class="stat-item">Edit existing blog post</span>
        </div>
    </div>
...
<div class="content-body">
    <div class="form-container">
        ...
        <form action="index.php?action=blog&method=edit&id=<?php echo $post['_id']; ?>" method="POST" enctype="multipart/form-data" id="blogForm">
            <div class="row">
                <div class="col-lg-8">
                    <div class="form-group">
                        <label for="title" class="form-label">Post Title *</label>
                        <input type="text" class="form-control" id="title" name="title" required maxlength="200" 
                               value="<?php echo htmlspecialchars($post['title']); ?>" placeholder="Enter blog post title">
                        <div class="form-text">Enter a compelling title for your blog post (max 200 characters)</div>
                    </div>
                    
                    <div class="form-group">
                        <label for="content" class="form-label">Content *</label>
                        <textarea class="form-control" id="content" name="content" rows="15" required placeholder="Write your blog post content here"><?php echo htmlspecialchars($post['content']); ?></textarea>
                        <div class="form-text">Write your blog post content here. You can use HTML formatting.</div>
                    </div>
                    
                    <div class="form-group">
                        <label for="excerpt" class="form-label">Excerpt</label>
                        <textarea class="form-control" id="excerpt" name="excerpt" rows="3" placeholder="Brief summary of the post (optional)"><?php echo htmlspecialchars($post['excerpt'] ?? ''); ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status">
                                    ...
                                    <option value="published" <?php echo ($post['status'] ?? 'draft') === 'published' ? 'selected' : ''; ?>>Published</option>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tags" name="tags" 
                               value="<?php echo htmlspecialchars(is_array($post['tags'] ?? []) ? implode(', ', $post['tags']) : ($post['tags'] ?? '')); ?>" 
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <div class="form-text">Upload a new featured image for your blog post (optional)</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="meta_title" name="meta_title" maxlength="60" 
                               value="<?php echo htmlspecialchars($post['meta_title'] ?? ''); ?>" placeholder="SEO meta title">
                        <div class="form-text">SEO meta title (max 60 characters)</div>
                    </div>
                    
                    <div class="form-group">
                        <label for="meta_description" class="form-label">Meta Description</label>
                        <textarea class="form-control" id="meta_description" name="meta_description" rows="3" maxlength="160" placeholder="SEO meta description"><?php echo htmlspecialchars($post['meta_description'] ?? ''); ?></textarea>
